...
This is a sample template for sitting-ducks - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sitting-ducks --query 'Stacks[].Outputs'
```
